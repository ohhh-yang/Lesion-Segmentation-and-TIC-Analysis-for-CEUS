...
from models.experimental import SE_Block, CoordAttention, CBAM, ASFF, ASPP
...
def parse_model(d, ch):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        # TODO: channel, gw, gd
            ...
            # 特殊处理 SE_Block、CoordAttention 和 CBAM
        elif m in {SE_Block, CoordAttention, CBAM}:
            c1 = ch[f]  # 输入通道数
            args = [c1, *args]  # 重新组织参数
            c2 = c1  # 输出通道与输入通道相等
